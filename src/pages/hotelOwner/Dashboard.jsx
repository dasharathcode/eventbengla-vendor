            ...
            {dashboardData.hotel && (
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-800">
                        Welcome, <span className="text-blue-600">{dashboardData.hotel.OwnerName}</span> 🎉
                    </h1>
                    <p className="text-gray-500 text-sm mt-1">
                        Managing <span className="font-medium text-gray-700">{dashboardData.hotel.businessName}</span>
                        {" "}in {dashboardData.hotel.city}
                    </p>
                </div>
            )}
