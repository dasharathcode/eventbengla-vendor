...
const Sidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { name: "Listing Add ", path: "/owner/add-BanquetHall", icon: assets.addVendorIcon, type: "Banquet Halls" },
        { name: "Listed ", path: "/owner/list-vendor", icon: assets.listVendorIcon, type: "Banquet Halls" },

        // // Caterer এর জন্য
        // { name: "Add Caterer", path: "/owner/add-vendor", icon: assets.addVendorIcon, type: "Wedding Resorts" },
        // { name: "List Caterer", path: "/owner/list-vendor", icon: assets.listVendorIcon, type: "Wedding Resorts" },

        // // Decorator এর জন্য
        // { name: "Add Decorator", path: "/owner/add-vendor", icon: assets.addVendorIcon, type: "Banquet Hall" },
        // { name: "List Decorator", path: "/owner/list-vendor", icon: assets.listVendorIcon, type: "Banquet Hall" },
    ];

    // Filter করা হচ্ছে
    const filteredLinks = sidebarLinks.filter(link =>
        link.type === "common" || vendorType.includes(link.type)
    );
